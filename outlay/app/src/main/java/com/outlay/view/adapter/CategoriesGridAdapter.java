...
import com.outlay.view.numpad.NumpadValidator;
...
public class CategoriesGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case HEADER:
                final View numpadView = inflater.inflate(R.layout.recycler_numpad, parent, false);
                GridLayoutManager.LayoutParams params = (GridLayoutManager.LayoutParams) numpadView.getLayoutParams();
                params.height = parent.getMeasuredHeight() - (context.getResources().getDimensionPixelSize(R.dimen.category_item_height) * 2);

                final NumpadViewHolder viewHolder = new NumpadViewHolder(numpadView);
                return viewHolder;
            default:
                final View catView = inflater.inflate(R.layout.item_category, parent, false);
